            ...
            <!-- Top card row for CURRENT BILLING CYCLE + TOP 5 CSAs -->
             ...
             <div class=" bg-white border rounded-md border-gray-200  px-6 py-4">
                 ...
                 <div class=" grid grid-cols-4 gap-x-4 gap-y-8">
                     ...
                     <!-- card total assigned-->
                     <div class="hover-sweep flex items-center justify-between bg-gray-50 border-t-8 border-primary rounded-sm px-4 py-4 cursor-default hover:shadow-md transition-all duration-300 ease-in-out ">
                         <div class="">
                     ...
                     <!-- card total read -->
                     <div class="hover-sweep flex items-center justify-between bg-gray-50 border-t-8 border-green-500 rounded-sm px-4 py-4 cursor-default hover:shadow-md transition-all duration-300 ease-in-out ">
                         <div class="">
                     ...
                     <!-- card total not read-->
                     <div class="hover-sweep flex items-center justify-between bg-gray-50 border-t-8 border-amber-400 rounded-sm px-4 py-4 cursor-default hover:shadow-md transition-all duration-300 ease-in-out ">
                         <div class="">
                     ...
                     <!-- card abnormal -->
                     <div class="hover-sweep flex items-center justify-between bg-gray-50 border-t-8 border-red-400 rounded-sm px-4 py-4 cursor-default hover:shadow-md transition-all duration-300 ease-in-out ">
                         <div class="">
                     ...
                     <div class="hover-sweep flex items-center justify-between bg-gray-50 border-t-8 border-slate-400 rounded-sm px-4 py-4 cursor-default hover:shadow-md transition-all duration-300 ease-in-out ">
                         <div class="">
                     ...
                     <div class="hover-sweep flex items-center justify-between bg-gray-50 border-t-8 border-orange-400 rounded-sm px-4 py-4 cursor-default hover:shadow-md transition-all duration-300 ease-in-out ">
                         <div class="">
